...
void emu_t::and16(uint16_t& op1_, uint16_t op2_)
{
...
void emu_t::xor8(uint8_t & op1_, uint8_t op2_) { ASM_OP8_2_RES(xor, op1_, op2_) }

void emu_t::or16(uint16_t & op1_, uint16_t op2_)
{
	ASM_OP16_2_RES(or, op1_, op2_)
}

void emu_t::or8(uint8_t & op1_, uint8_t op2_)
{
	ASM_OP8_2_RES(or, op1_, op2_)
}

void emu_t::xor16(uint16_t & op1_, uint16_t op2_) { ASM_OP16_2_RES(xor, op1_, op2_) }
