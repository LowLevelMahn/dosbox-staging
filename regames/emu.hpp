...
public:
    ...
    void and16( uint16_t& op1_, uint16_t op2_ );
    ...
    void xor8( uint8_t& op1_, uint8_t op2_ );

    void or16( uint16_t& op1_, uint16_t op2_ );
    void or8( uint8_t& op1_, uint8_t op2_ );
    void xor16( uint16_t& op1_, uint16_t op2_ );
